...
```
https://cdn.statically.io/gh/openplatform-labs/logos@main/logos/react.svg
```

HTML에서는 이렇게 사용합니다.

```html
<img src="https://cdn.statically.io/gh/openplatform-labs/logos@main/logos/react.svg" alt="React" />
```
